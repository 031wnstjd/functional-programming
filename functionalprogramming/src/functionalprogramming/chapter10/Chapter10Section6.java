...
import functionalprogramming.chapter10.model.Order;
import functionalprogramming.chapter10.model.Order.OrderStatus;
import functionalprogramming.chapter10.model.OrderLine;
import functionalprogramming.chapter10.service.OrderProcessStep;
	...
	public static void main(String[] args) {
		...
		OrderProcessStep completeProcessingOrderStep = new OrderProcessStep(order -> {
			if (order.getStatus() == OrderStatus.PROCESSED) {
				System.out.println("Finished processing orcder " + order.getId());
			}
		});
